...
func main() {
	...
	dbConnStr := os.Getenv("GREENLIGHT_DB_DSN")

	flag.StringVar(&cfg.db.dsn, "db-dsn", dbConnStr, "PostgreSQL DSN")
	...
	flag.StringVar(&cfg.smtp.password, "smtp-password", "oxjbptdcadochajn", "SMTP password")
